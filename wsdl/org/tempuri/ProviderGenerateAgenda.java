 ...
 *         &lt;element name="pattern" type="{http://schemas.datacontract.org/2004/07/MeetMD.Models.DomainModel}ArrayOfTimeslotPatternXml" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ProviderGenerateAgenda")
public class ProviderGenerateAgenda {
    ...
    protected JAXBElement<ArrayOfTimeslotPatternXml> pattern;
     ...
     *     
     */
    public JAXBElement<ArrayOfTimeslotPatternXml> getPattern() {
        return pattern;
    }
     ...
     *     
     */
    public void setPattern(JAXBElement<ArrayOfTimeslotPatternXml> value) {
        this.pattern = value;
    }
