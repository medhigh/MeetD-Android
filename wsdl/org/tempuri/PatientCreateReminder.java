 ...
 *         &lt;element name="reminder" type="{http://schemas.datacontract.org/2004/07/MeetMD.Models.DomainModel}PatientReminderXml" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PatientCreateReminder")
public class PatientCreateReminder {
    ...
    @XmlElementRef(name = "reminder", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<PatientReminderXml> reminder;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PatientReminderXml }{@code >}
     *     
     */
    public JAXBElement<PatientReminderXml> getReminder() {
        return reminder;
    }
     ...
     *     
     */
    public void setReminder(JAXBElement<PatientReminderXml> value) {
        this.reminder = value;
    }
