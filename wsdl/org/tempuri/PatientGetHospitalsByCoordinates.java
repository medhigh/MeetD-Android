...
@XmlRootElement(name = "PatientGetHospitalsByCoordinates")
public class PatientGetHospitalsByCoordinates {
    ...
    @XmlElementRef(name = "coordinates", namespace = "http://tempuri.org/", type = JAXBElement.class)
