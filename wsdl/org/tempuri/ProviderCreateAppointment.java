 ...
 *         &lt;element name="timeslotId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "ProviderCreateAppointment")
public class ProviderCreateAppointment {
    ...
    @XmlElementRef(name = "timeslotId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> timeslotId;
    @XmlElementRef(name = "insuranceNumber", namespace = "http://tempuri.org/", type = JAXBElement.class)
     ...
     *     
     */
    public JAXBElement<String> getTimeslotId() {
        return timeslotId;
    }
     ...
     *     
     */
    public void setTimeslotId(JAXBElement<String> value) {
