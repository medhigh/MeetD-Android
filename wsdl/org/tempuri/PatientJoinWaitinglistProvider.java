...
@XmlRootElement(name = "PatientJoinWaitinglistProvider")
public class PatientJoinWaitinglistProvider {
    ...
    @XmlElementRef(name = "providerId", namespace = "http://tempuri.org/", type = JAXBElement.class)
