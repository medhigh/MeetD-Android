...
@XmlRootElement(name = "ProviderRemoveLocation")
public class ProviderRemoveLocation {
    ...
    @XmlElementRef(name = "location", namespace = "http://tempuri.org/", type = JAXBElement.class)
