 ...
 *         &lt;element name="reminderId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PatientRemoveReminder")
public class PatientRemoveReminder {
    ...
    @XmlElementRef(name = "reminderId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> reminderId;
     ...
     *     
     */
    public JAXBElement<String> getReminderId() {
        return reminderId;
    }
     ...
     *     
     */
    public void setReminderId(JAXBElement<String> value) {
