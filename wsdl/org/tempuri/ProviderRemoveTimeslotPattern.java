...
@XmlRootElement(name = "ProviderRemoveTimeslotPattern")
public class ProviderRemoveTimeslotPattern {
    ...
    @XmlElementRef(name = "patternId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> patternId;
     ...
     *     
     */
    public JAXBElement<String> getPatternId() {
        return patternId;
    }
     ...
     *     
     */
    public void setPatternId(JAXBElement<String> value) {
