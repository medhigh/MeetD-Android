 ...
 *         &lt;element name="newTimeslotId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PatientChangeAppointment")
public class PatientChangeAppointment {
    ...
    @XmlElementRef(name = "newTimeslotId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> newTimeslotId;
    ...
    /**
     * Gets the value of the newTimeslotId property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getNewTimeslotId() {
        return newTimeslotId;
    }

    /**
     * Sets the value of the newTimeslotId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNewTimeslotId(JAXBElement<String> value) {
        this.newTimeslotId = value;
    }
