...
//
import com.Wsdl2Code.WebServices.ServiceProviderBinding.LocationXml;
...
public class ServiceProviderXml implements KvmSerializable {
    ...
    public int appointmentsPerPatient;
    public boolean appointmentsPerPatientSpecified;
    ...
    public ServiceProviderXml(SoapObject soapObject)
    {
        ...
        if (soapObject.hasProperty("AppointmentsPerPatient"))
        {
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                ...
                appointmentsPerPatient = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                appointmentsPerPatient = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("AppointmentsPerPatientSpecified"))
        {
            Object obj = soapObject.getProperty("AppointmentsPerPatientSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                appointmentsPerPatientSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                appointmentsPerPatientSpecified = (Boolean) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 1:
                return appointmentsPerPatientSpecified;
            case 2:
                return contacts;
            case 3:
                return id;
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            ...
            case 1:
                ...
                info.name = "AppointmentsPerPatientSpecified";
                break;
            case 2:
