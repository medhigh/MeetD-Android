...
public class ColoredRatingBar extends View {
    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_full_24px),BitmapFactory.decodeResource(res, R.drawable.star_full_24px),BitmapFactory.decodeResource(res, R.drawable.star_full_24px)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_empty_24px);

        }else{
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_full_32px),BitmapFactory.decodeResource(res, R.drawable.star_full_32px),BitmapFactory.decodeResource(res, R.drawable.star_full_32px)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_empty_32px);
        }
    }
